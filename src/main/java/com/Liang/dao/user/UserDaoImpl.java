...
public class UserDaoImpl implements UserDao {
  ...
  public List<User> getUserList(
      Connection connection, String userName, int userRole, int currentPageNo, int pageSize)
      throws Exception {
    PreparedStatement ps = null;
    ResultSet rs = null;
  ...
  public User getUserById(Connection connection, int id) throws Exception {
    ...
    if (connection != null) {
      String sql =
          "select u.*,r.roleName as userRoleName from smbms_user u,smbms_role r where u.userRole = r.id and u.id = ?";
      Object[] params = {id};
